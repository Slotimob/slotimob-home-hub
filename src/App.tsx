...
const PropertyDetalhe = React.lazy(() => import("./pages/PropertyDetalhe"));
...
const AlugueisEmAberto = React.lazy(() => import("./pages/gestao/AlugueisEmAberto"));
...
/** Renders property detail when ?id= is present, otherwise the list page */
const PropertiesRoute = () => {
  const [searchParams] = useSearchParams();
  return searchParams.get("id") ? <PropertyDetalhe /> : <Properties />;
};
          ...
          <AuthProvider>
            ...
            <Routes>
             ...
             <Route path="/politica-de-privacidade" element={<Navigate to="/legal?tab=privacy" replace />} />
              ...
              <Route path="/properties" element={guarded(<PropertiesRoute />)} />
              ...
              <Route path="/gestao/alugueis-em-aberto" element={guarded(<RequireFeature feature="asset_management"><AlugueisEmAberto /></RequireFeature>)} />
