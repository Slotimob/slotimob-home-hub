export const HELP_FEATURES = {
  ...
  'finance.dre': 'DRE',
  'finance.dre_managerial': 'DRE Gerencial',
  'finance.dre_accounting': 'DRE Contábil',
...
export const HELP_DEFAULT_DESCRIPTIONS: Partial<Record<FeatureKey, string>> = {
  ...
  'finance.dre': 'Demonstrativo de resultado do período. Você escolhe o regime: Gerencial (por vencimento) ou Contábil (por data de emissão, competência).',
  'finance.dre_managerial': 'Cada lançamento entra no mês do seu vencimento. Mostra o resultado pelo calendário de cobranças e pagamentos previstos. Exemplo: o aluguel de setembro com vencimento em 05/10 aparece em outubro. Lançamentos sem vencimento usam a data de emissão. Inclui lançamentos ainda não pagos.',
  'finance.dre_accounting': 'Cada lançamento entra no mês da sua data de emissão (competência), ou seja, quando a receita ou despesa foi gerada, independente de quando vence ou é paga. Exemplo: o aluguel de setembro aparece em setembro mesmo vencendo em outubro. É o regime de competência usado pela contabilidade.',
