  ...
  return (
    <SectionWrapper background="white" id="dores">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {painPoints.map(({ icon: Icon, question, consequence }) => (
          <div
            key={question}
            className="group rounded-xl border border-border bg-card p-6 hover:shadow-md hover:border-destructive/30 transition-all duration-200"
          >
