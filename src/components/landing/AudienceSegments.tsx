...
const segments = [
  {
    ...
    description: 'Escalabilidade e Controle. Gerencie sua equipe, audite as finanças e garanta que nenhum lead seja perdido por falta de atendimento.',
    highlights: ['Gestão de equipe com permissões', 'Auditoria financeira completa', 'Distribuição automática de clientes'],
    color: 'bg-primary/10 text-primary',
  },
  {
    icon: UserCheck,
    title: 'Para o Corretor',
    description: 'Sua agência no bolso. Use calculadoras de financiamento na frente do cliente e organize seus fechamentos com agilidade.',
    highlights: ['Simulador de financiamento na hora', 'Pipeline visual de negociações', 'Comissões calculadas automaticamente'],
    color: 'bg-accent/10 text-accent',
  },
  {
    icon: Home,
    title: 'Para o Dono de Imóveis',
    description: 'Transparência total. Acompanhe a rentabilidade, documentos e a conservação do seu patrimônio em tempo real.',
    highlights: ['Lucro real por imóvel', 'Documentos sempre acessíveis', 'Alertas de vencimento e inadimplência'],
